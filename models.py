...
BITMEX_TF_MINUTES = {"1m": 1, "5m": 5, "1h": 60, "id": 144}
...
class Candle:
    def __init__(self, candle_info, timeframe, exchange) -> None:
        if exchange == "binance":
...
class Contract:
    def __init__(self, contract_info, exchange):
        ...
        if exchange == 'binance':
            ...
            self.qantity_decimals = tick_todecimals(contract_info['lotSize'])
